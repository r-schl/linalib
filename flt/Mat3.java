...
public class Mat3 implements Mat3Readable, MatWritable {
    ...
    public Mat3 mulRotation2(float angle) {
    ...
    public Mat3 mulRot3AroundAxis(Vec3Readable axis, float angle) {
        return mulRot3AroundAxis(axis.getX(), axis.getY(), axis.getZ(), angle);
    }

    public Mat3 mulRot3AroundAxis(float axisX, float axisY, float axisZ, float angle) {
    ...
    public Mat3 mulRot3AroundXAxis(float angle) {
    ...
    public Mat3 mulRot3AroundYAxis(float angle) {
        float cos = (float) Math.cos(Math.toRadians(angle));
        float sin = (float) Math.sin(Math.toRadians(angle));
        return this.mul(
            cos, 0, sin,
    ...
    public Mat3 mulRot3AroundZAxis(float angle) {
        float cos = (float) Math.cos(Math.toRadians(angle));
        float sin = (float) Math.sin(Math.toRadians(angle));
    ...
    public Mat3 mulRotation3(Vec3Readable forward, Vec3Readable up, Vec3Readable right) {
        return mulRotation3(forward.getX(), forward.getY(), forward.getZ(), up.getX(), up.getY(), up.getZ(), right.getX(), right.getY(), right.getZ());
    }

    public Mat3 mulRotation3(float fX, float fY, float fZ, float uX, float uY, float uZ, float rX, float rY, float rZ) {
        return this.mul(
            rX, rY, rZ,
            uX, uY, uZ,
            fX, fY, fZ
    ...
    public Mat3 mulRot3FromQuaternion(QuaternionReadable q) {
        return mulRot3FromQuaternion(q.getW(), q.getX(), q.getY(), q.getZ());
    }

    public Mat3 mulRot3FromQuaternion(float qw, float qx, float qy, float qz) {
    ...
    public Mat3 mulTranslation2(Vec2Readable v) {
        return mulTranslation2(v.getX(), v.getY());
    }

    public Mat3 mulTranslation2(float dX, float dY) {
        return this.mul(
            1, 0, dX,
            0, 1, dY,
            0, 0, 1
    ...
    public Mat3 mulScale2(Vec2Readable v) {
        return mulScale2(v.getX(), v.getY());
    }

    public Mat3 mulScale2(float scaleX, float scaleY) {
        return this.mul(
            scaleX, 0, 0,
            0, scaleY, 0,
            0, 0, 1
    ...
    public Mat3 mulScale3(Vec3Readable v) {
        return mulScale3(v.getX(), v.getY(), v.getZ());
    }
    
    public Mat3 mulScale3(float scaleX, float scaleY, float scaleZ) {
        return this.mul(
            scaleX, 0, 0,
            0, scaleY, 0,
            0, 0, scaleZ
    ...
    public static Mat3 newRotation2(float angle) {
        return new Mat3(IDENTITY).mulRotation2(angle);
    }

    public static Mat3 newRot3AroundAxis(Vec3Readable axis, float angle) {
        return new Mat3(IDENTITY).mulRot3AroundAxis(axis, angle);
    }

    public static Mat3 newRot3AroundAxis(float axisX, float axisY, float axisZ, float angle) {
        return new Mat3(IDENTITY).mulRot3AroundAxis(axisX, axisY, axisZ, angle);
    }

    public static Mat3 newRot3AroundXAxis(float angle) {
        return new Mat3(IDENTITY).mulRot3AroundXAxis(angle);
    }

    public static Mat3 newRot3AroundYAxis(float angle) {
        return new Mat3(IDENTITY).mulRot3AroundYAxis(angle);
    }

    public static Mat3 newRot3AroundZAxis(float angle) {
        return new Mat3(IDENTITY).mulRot3AroundZAxis(angle);
    }

    public static Mat3 newRotation3(Vec3Readable forward, Vec3Readable up, Vec3Readable right) {
        return new Mat3(IDENTITY).mulRotation3(forward, up, right);
    }
    
    public static Mat3 newRotation3(float fX, float fY, float fZ, float uX, float uY, float uZ, float rX, float rY, float rZ) {
        return new Mat3(IDENTITY).mulRotation3(fX, fY, fZ, uX, uY, uZ, rX, rY, rZ);
    }

    public static Mat3 newRot3FromQuaternion(QuaternionReadable q) {
        return new Mat3(IDENTITY).mulRot3FromQuaternion(q);
    }

    public static Mat3 newRot3FromQuaternion(float qw, float qx, float qy, float qz) {
        return new Mat3(IDENTITY).mulRot3FromQuaternion(qw, qx, qy, qz);
    }

    public static Mat3 newTranslation2(Vec2Readable translation) {
        return new Mat3(IDENTITY).mulTranslation2(translation);
    }

    public static Mat3 newTranslation2(float dX, float dY) {
        return new Mat3(IDENTITY).mulTranslation2(dX, dY);
    }

    public static Mat3 newScale2(Vec2Readable scale) {
        return new Mat3(IDENTITY).mulScale2(scale);
    }

    public static Mat3 newScale2(float scaleX, float scaleY) {
        return new Mat3(IDENTITY).mulScale2(scaleX, scaleY);
    }

    public static Mat3 newScale3(Vec3Readable scale) {
        return new Mat3(IDENTITY).mulScale3(scale);
    }

    public static Mat3 newScale3(float scaleX, float scaleY, float scaleZ) {
        return new Mat3(IDENTITY).mulScale3(scaleX, scaleY, scaleZ);
    }
