...
public class Mat3x3 implements Mat3x3Writable {
    ...
    public Mat3x3(Mat3x3Readable other) {
    ...
    @Override
    public Mat3x3 to(MatWritable mat) {
        this.extractTo(mat);
        return this;
    }
    ...
    @Override
    public Mat3x3 set(int r, int c, float val) {
    ...
    @Override
    public Mat3x3 floorElWise(float r) {
    ...
    @Override
    public Mat3x3 addElWise(float r) {
        this.m00 = this.m00 + r;
        this.m01 = this.m01 + r;
        this.m02 = this.m02 + r;
        this.m10 = this.m10 + r;
    ...
    @Override
    public Mat3x3 subElWise(float r) {
        this.m00 = this.m00 - r;
        this.m01 = this.m01 - r;
        this.m02 = this.m02 - r;
        this.m10 = this.m10 - r;
    ...
    @Override
    public Mat3x3 mulElWise(float r) {
        this.m00 = this.m00 * r;
        this.m01 = this.m01 * r;
        this.m02 = this.m02 * r;
        this.m10 = this.m10 * r;
    ...
    @Override
    public Mat3x3 divElWise(float r) {
        this.m00 = this.m00 / r;
        this.m01 = this.m01 / r;
        this.m02 = this.m02 / r;
        this.m10 = this.m10 / r;
    ...
    @Override
    public Mat3x3 from(MatReadable mat) {
        this.extractFrom(mat);
        return this;
    }

    @Override
    public Mat3x3 set00(float val) {
        this.m00 = val;
        return this;
    }

    @Override
    public Mat3x3 set01(float val) {
        this.m01 = val;
        return this;
    }

    @Override
    public Mat3x3 set02(float val) {
        this.m02 = val;
        return this;
    }

    @Override
    public Mat3x3 set10(float val) {
        this.m10 = val;
        return this;
    }

    @Override
    public Mat3x3 set11(float val) {
        this.m11 = val;
        return this;
    }

    @Override
    public Mat3x3 set12(float val) {
        this.m12 = val;
        return this;
    }

    @Override
    public Mat3x3 set20(float val) {
        this.m20 = val;
        return this;
    }

    @Override
    public Mat3x3 set21(float val) {
        this.m21 = val;
        return this;
    }

    @Override
    public Mat3x3 set22(float val) {
        this.m22 = val;
        return this;
    }

    @Override
    public Mat3x3 set(Mat3x3Readable mat) {
        this.m00 = mat.get00();
        this.m01 = mat.get01();
        this.m02 = mat.get02();
        this.m10 = mat.get10();
    ...
    @Override
    public Mat3x3 set(float mat00, float mat01, float mat02,
    ...
    @Override
    public Mat3x3 addElWise(Mat3x3Readable mat) {
    ...
    @Override
    public Mat3x3 addElWise(float mat00, float mat01, float mat02, float mat10, float mat11, float mat12,
            float mat20, float mat21, float mat22) {
    ...
    @Override
    public Mat3x3 subElWise(Mat3x3Readable mat) {
        this.m00 = this.m00 - mat.get00();
        this.m01 = this.m01 - mat.get01();
        this.m02 = this.m02 - mat.get02();
        this.m10 = this.m10 - mat.get10();
    ...
    @Override
    public Mat3x3 subElWise(float mat00, float mat01, float mat02, float mat10, float mat11, float mat12,
            float mat20, float mat21, float mat22) {
        this.m00 = this.m00 - mat00;
        this.m01 = this.m01 - mat01;
        this.m02 = this.m02 - mat02;
    ...
    @Override
    public Mat3x3 mulElWise(Mat3x3Readable mat) {
        this.m00 = this.m00 * mat.get00();
        this.m01 = this.m01 * mat.get01();
        this.m02 = this.m02 * mat.get02();
        this.m10 = this.m10 * mat.get10();
    ...
    @Override
    public Mat3x3 mulElWise(float mat00, float mat01, float mat02, float mat10, float mat11, float mat12,
            float mat20, float mat21, float mat22) {
        this.m00 = this.m00 * mat00;
        this.m01 = this.m01 * mat01;
        this.m02 = this.m02 * mat02;
    ...
    @Override
    public Mat3x3 divElWise(Mat3x3Readable mat) {
        this.m00 = this.m00 / mat.get00();
        this.m01 = this.m01 / mat.get01();
        this.m02 = this.m02 / mat.get02();
        this.m10 = this.m10 / mat.get10();
    ...
    @Override
    public Mat3x3 divElWise(float mat00, float mat01, float mat02, float mat10, float mat11, float mat12,
            float mat20, float mat21, float mat22) {
        this.m00 = this.m00 / mat00;
        this.m01 = this.m01 / mat01;
        this.m02 = this.m02 / mat02;
    ...
    @Override
    public Mat3x3 mul(Mat3x3Readable mat) {
    ...
    @Override
    public Mat3x3 mul(float mat00, float mat01, float mat02, float mat10, float mat11, float mat12, float mat20,
    ...
    @Override
    public Mat3x3 rot3dAroundAxis(Vec3Readable axis, float angle) {
        return rot3dAroundAxis(axis.getX(), axis.getY(), axis.getZ(), angle);
    }

    @Override
    public Mat3x3 rot3dAroundAxis(float axisX, float axisY, float axisZ, float angle) {
    ...
    @Override
    public Mat3x3 rot3dAroundXAxis(float angle) {
    ...
    @Override
    public Mat3x3 rot3dAroundYAxis(float angle) {
        float cos = (float) Math.cos(Math.toRadians(angle));
        float sin = (float) Math.sin(Math.toRadians(angle));
        return this.mul(
            cos, 0, sin,
    ...
    @Override
    public Mat3x3 rot3dAroundZAxis(float angle) {
        float cos = (float) Math.cos(Math.toRadians(angle));
        float sin = (float) Math.sin(Math.toRadians(angle));
    ...
    public Mat3x3 rot3dByQuaternion(QuatReadable q) {
        return rot3dByQuaternion(q.getW(), q.getX(), q.getY(), q.getZ());
    }

    public Mat3x3 rot3dByQuaternion(float qw, float qx, float qy, float qz) {
    ...
    @Override
    public Mat3x3 translation2d(Vec2Readable v) {
    ...
    @Override
    public Mat3x3 scale2d(Vec2Readable v) {
    ...
    @Override
    public Mat3x3 scale3d(Vec3Readable v) {
        return scale3d(v.getX(), v.getY(), v.getZ());
    }
    
    @Override
    public Mat3x3 scale3d(float scaleX, float scaleY, float scaleZ) {
        return this.mul(
            scaleX, 0, 0,
            0, scaleY, 0,
            0, 0, scaleZ
